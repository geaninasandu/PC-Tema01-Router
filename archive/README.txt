...
> Cel putin 20 de ore, din cauza unor bug-uri care s-au dovedit a fi minore, din cauza ca C-ul cam
    da batai de cap - eg. folosirea de variabile de tip long (care in general nu prea puteau fi
    asignate intre ele), teste de forwarding care nu trec desi trec toate ping-urile intre host-uri,
    checksum gresit la pachetele ICMP).
...
>>> Forwarding
        ...
        > Verificam mai departe daca IP-ul destinatie corespunde unei intrari din ARP table. Daca
            nu, adauga pachetul in queue si trimite un ARP request catre IP-ul destinatie.
        > Forwardeaza pachetul dupa ce primeste ARP reply.
